        ...
        try:
            ...
            def repl(match):
                ...
                if (
                    ...
                    len(soup.contents) == 1 and
                    getattr(soup.contents[0], 'name', '') == 'ac:image'
                ):
                    return str(soup)
                ...
                return (
                    f'<ac:link>'
                    f'<ri:page ri:content-title="{inner_text_clean}" ri:space-key={tooltip_space_key} />'
                    f'<ac:plain-text-link-body><![CDATA[{inner_text_clean}]]></ac:plain-text-link-body>'
                    f'</ac:link>'
                )
            ...
            print(f"[highlight_externalid] Error: {e}")
            return html_content
...
#print(headers_1,"Header 1",headers_2)
